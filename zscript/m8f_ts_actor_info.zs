...
class m8f_ts_ActorInfo
{
  ...
  static ui string GetTargetFlags(Actor target)
  {
    string result = "";
  ...
  static ui int GetActorMaxHealth(Actor a)
  {
    if (a == null)     { return 0; }
  ...
  static ui bool IsIdle(Actor a)
  {
    return a.target == null;
  }

  static ui int CustomTargetColor(Actor target)
  {
